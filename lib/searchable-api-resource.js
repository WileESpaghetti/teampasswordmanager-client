...
var PagedApiResource = require('./paged-api-resource');
...
var SearchableApiResource = function(config) {
    ...
    PagedApiResource.call(_resource, config);
...
SearchableApiResource.prototype = new PagedApiResource();
